...
export class SuperAdminService {
  ...
  async syncModulesAndPermissions() {
    try {
      const modules = [
        { slug: 'dashboard', name: 'Super Dashboard', path: '/super-admin/dashboard', icon: 'LayoutDashboard', sortOrder: 1 },
        { slug: 'revenue', name: 'Revenue Reports', path: '/super-admin/revenue', icon: 'DollarSign', sortOrder: 2 },
        { slug: 'communities', name: 'Communities', path: '/super-admin/communities', icon: 'Globe', sortOrder: 3 },
        { slug: 'users', name: 'All Members', path: '/super-admin/users', icon: 'Users', sortOrder: 4 },
        ...
        { slug: 'static_pages', name: 'Static Pages', path: '/admin/static-pages', icon: 'FileQuestion', sortOrder: 13 },
        { slug: 'ai_biodata', name: 'AI Biodata Engine', path: '/super-admin/ai-biodata', icon: 'Sparkles', sortOrder: 14 },
        { slug: 'biodata_entry', name: 'Biodata Form Entry', path: '/super-admin/biodata-entry', icon: 'FileText', sortOrder: 15 },
        { slug: 'biodata_list', name: 'Biodata Records List', path: '/super-admin/biodata-list', icon: 'ScrollText', sortOrder: 16 },
        { slug: 'admins', name: 'Admins & Roles (UAM)', path: '/super-admin/admins', icon: 'Shield', sortOrder: 17 },
        { slug: 'audit', name: 'Audit Logs', path: '/super-admin/audit-logs', icon: 'ScrollText', sortOrder: 18 },
        { slug: 'reports', name: 'User Reports', path: '/super-admin/reports', icon: 'AlertTriangle', sortOrder: 19 },
        { slug: 'system_settings', name: 'System Settings', path: '/super-admin/system-settings', icon: 'Sliders', sortOrder: 20 },
        { slug: 'settings', name: 'Settings', path: '/super-admin/settings', icon: 'Settings', sortOrder: 21 },
        { slug: 'legacy_logs', name: 'Legacy Logs', path: '/super-admin/logs', icon: 'FileText', sortOrder: 22 },
        { slug: 'member_dashboard', name: 'Member Portal Dashboard', path: '/dashboard', icon: 'LayoutDashboard', sortOrder: 23 },
        { slug: 'member_profile', name: 'Member Portal My Profile', path: '/profile', icon: 'User', sortOrder: 24 },
        { slug: 'member_search', name: 'Member Portal Search & Matches', path: '/search', icon: 'Search', sortOrder: 25 },
        { slug: 'member_interests', name: 'Member Portal Interests', path: '/interests', icon: 'Heart', sortOrder: 26 },
  ...
  async getReportsAnalytics() {
    try {
      const [
        ...
        this.prisma.membership.count({ where: { tier: 'ELITE' } }).catch(() => 0),
