...
export function buildCanonicalProfileJson(
  ...
  return {
    ...
    propertyDetails: strOrNull(prof.propertyDetails || inp.propertyDetails || inp.property || fam.property_assets || fam.propertyAssets || fam.propertyDetails || p.propertyDetails),
    familyWorth: strOrNull(prof.familyWorth || fam.family_worth || fam.familyWorth || inp.familyWorth || inp.familyAssets || p.familyWorth),
    individualWorth: strOrNull(prof.individualWorth || car.individual_worth || car.individualWorth || inp.individualWorth || inp.individualAssets || p.individualWorth),
    ...
    career: {
      ...
      individualWorth: strOrNull(car.individual_worth || car.individualWorth || inp.individualWorth || inp.individualAssets || prof.individualWorth || p.individualWorth),
    ...
    family: {
      ...
      familyWorth: strOrNull(fam.family_worth || fam.familyWorth || inp.familyWorth || inp.familyAssets || fam.property_assets || fam.propertyAssets || p.familyWorth),
      nativePlace: strOrNull(fam.native_place || fam.nativePlace || inp.nativePlace),
      propertyAssets: strOrNull(fam.property_assets || fam.propertyAssets || inp.propertyAssets || inp.propertyDetails || inp.property || fam.propertyDetails || p.propertyDetails),
    },
