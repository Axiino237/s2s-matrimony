...
import {
  ...
  Sliders, Lock, Save, CheckCircle2, ShieldCheck, ChevronRight, Upload, Phone, Mail, Loader2, ArrowRight, Sparkles
} from 'lucide-react';
    ...
    <div className="flex flex-col md:flex-row gap-6 animate-fade-in">
      ...
      <div className="flex-1 min-w-0 space-y-6">
        ...
        {activeSection === 'family' && (
          <div className="card p-6 space-y-4 bg-white border border-slate-200 shadow-sm">
            <h2 className="text-text-primary font-bold text-xs uppercase tracking-wider border-b border-slate-100 pb-2">Family Background</h2>
            <div className="grid sm:grid-cols-2 gap-4">
        ...
        {activeSection === 'horoscope' && (
          <div className="card p-6 space-y-4 bg-white border border-slate-200 shadow-sm">
            <h2 className="text-text-primary font-bold text-xs uppercase tracking-wider border-b border-slate-100 pb-2">Horoscope Details</h2>
            <div className="grid sm:grid-cols-2 gap-4">
              <div><label className="input-label">Star (Nakshatra)</label><input className="input border-slate-200 text-text-primary w-full" value={formData.star} onChange={(e) => handleChange('star', e.target.value)} /></div>
              <div><label className="input-label">Rasi (Moon Sign)</label><input className="input border-slate-200 text-text-primary w-full" value={formData.rasi} onChange={(e) => handleChange('rasi', e.target.value)} /></div>
              <div><label className="input-label">Lagnam</label><input className="input border-slate-200 text-text-primary w-full" value={formData.lagnam} onChange={(e) => handleChange('lagnam', e.target.value)} /></div>
              <div><label className="input-label">Gothram</label><input className="input border-slate-200 text-text-primary w-full" value={formData.gothram} onChange={(e) => handleChange('gothram', e.target.value)} /></div>
            </div>
          </div>
        )}
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                >
                  ...
                  {Object.keys(CASTE_SUBCASTES).map((c) => (
